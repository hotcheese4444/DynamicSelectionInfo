ReUI.Options.Mods["DynamicSelectionInfo"] = {
...
function Main()
    ...
    local options = ReUI.Options.Mods["DynamicSelectionInfo"]
    builder.AddOptions("DynamicSelectionInfo", "Dynamic Selection Info", {
